...
\begin{figure}[H]
  \begin{center}
    \subfigure[ゲーム画面：加工前]{
      \includegraphics[width=0.4\textwidth,keepaspectratio]{img/e.png}
    }
    \subfigure[ゲーム画面：加工後]{
      \includegraphics[width=0.4\textwidth,keepaspectratio]{img/f.png}
    }
  \end{center}
\end{figure}
\begin{figure}[H]
  \begin{center}
    \subfigure[ゲーム画面：組み合わせ後]{
      \includegraphics[width=0.4\textwidth,keepaspectratio]{img/g.png}
    }
    \subfigure[ゲーム画面：提供]{
      \includegraphics[width=0.4\textwidth,keepaspectratio]{img/h.png}
    }
  \end{center}
\end{figure}
\newpage
